...
![Dropdown menu image](resources/dropdown_menus.png)
...
![Menu debug display](resources/menu_debug_dump.png)

Extracting out the active trail gives this useful information:

![Active trail debug display](resources/active_trail_debug.png)
