...
![Modal dialog title](resources/dialog-title.png)
...
![modal example 1](resources/modal-example1.png)
...
![First dialog](resources/first-dialog.png)


And the second

![Second dialog](resources/second-dialog.png)
...
![Initial form](resources/initial-form.png)

And here is the modal popped up over it:

![Modal over initial form](resources/modal-over-initial-form.png)
...
![Slide-in example](resources/slide-in-example.png)
...
![First slide-in modal](resources/first-modal.png)

And the second which shows the dialog sliding in from the top:

![Second slide-in modal](resources/second-modal.png)

Here is our custom form sliding in:

![Third slide-in modal](resources/third-modal.png)

And finally the login form sliding in:

![Fourth slide-in modal](resources/fourth-modal.png)
